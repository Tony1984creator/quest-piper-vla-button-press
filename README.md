...
| CIAT / SmolVLA | A private VLA-Corrector experiment harness was extended with 15 frozen LIBERO-Long keyframe states, v3/v4 counterfactual collections, paired controls, state-held-out absolute-Q/CRA audits, AFCR ±axis-pair auditing, and two fresh-state data-design falsification pilots (BUCED and MACE). | Offline probe | Records reproducible offline engineering plus negative AFCR, BUCED, and MACE results; none support an online Q-gradient capability claim. |
