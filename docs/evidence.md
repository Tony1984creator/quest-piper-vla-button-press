...
| CIAT / SmolVLA | Built frozen-policy, causal-anchor, paired-control counterfactual branches and state-held-out terminal-outcome audits on LIBERO-Long. | Offline probe | I separate a reproducible correction experiment from an unproven online Q-gradient claim. |
