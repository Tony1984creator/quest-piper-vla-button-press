...
| CIAT / SmolVLA | Extended a private experiment harness with causal keyframes, exact-prefix replay, paired controls, 15 frozen states, v3/v4 state-held-out absolute-Q versus CRA audits, and a 105-pair AFCR axis-direction audit. | Offline probe | I turned a Q-gradient idea into auditable offline experiments, recorded that neither CRA v1 nor AFCR v1 has shown a stable held-out direction/ranking signal, and kept online guidance out of scope. |
